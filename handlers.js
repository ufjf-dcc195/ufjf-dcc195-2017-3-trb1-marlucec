...
var queryData = url.parse(req.url, true).query;
  var ini = queryData.n1;
    var fim = queryData.n2;
    var l = 0;
    var i = 0;

  if(queryData.n1<queryData.n2 && queryData.n1<100 && queryData.n2<100 )
  {
...
res.write("os numeros primos são:");
  ...
  function equacao(req, res){
   ...
   res.write("<P>" + "RAIZ DE DELTA = " + Math.round(raiz) + "</P>");
   res.write("<P>" + "VALOR DE X LINHA = " + Math.round(x1) + "</P>");
   res.write("<P>" + "VALOR DE X DUAS LINHAS = " + Math.round(x2) + "</P>");
